...
class App extends Component {
  state = { loaded: false, kycAddress: null , tokenSaleAddress: "" , userTokens: 0 };
  ...
  componentDidMount = async () => {
    try {
      ...
      this.setState({ loaded:true, kycAddress: "0x123", tokenSaleAddress: this.myTokenSale._address}, this.updateUserTokens);
    } catch (error) {
